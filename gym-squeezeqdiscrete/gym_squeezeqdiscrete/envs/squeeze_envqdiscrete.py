...
class SqueezeEnvqdiscrete(gym.Env):
      ...
      def __init__(self,q=1e-4,X=0.499*k,dt=1e-4,monkey=False,plot=False,eval=False):
              
              super(SqueezeEnvqdiscrete, self).__init__() 
      ...
      def step(self, action):
              ...
              time+=1
              self.time=time
              return output , self.current_reward , self.Done , {'costoP': costoP, 'costoQ':costoQ,'K(t)':K,'incr':delta}
